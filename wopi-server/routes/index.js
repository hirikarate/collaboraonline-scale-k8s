...
router.get('/collaboraUrl', function(req, res) {
  ...
  // var collaboraOnlineHost = 'http://collabora-service';
  var httpClient = collaboraOnlineHost.startsWith('https') ? https : http;
  var data = '';
  var discoveryUrl = collaboraOnlineHost + '/hosting/discovery';
  console.log('discoveryUrl: ' + discoveryUrl);
  var request = httpClient.get(discoveryUrl, function(response) {
